"""
Django settings for ramais_project project.
...
SECRET_KEY = 'django-insecure-asdf#FGSgvasgf$5$WGT-change-in-production'
...
ROOT_URLCONF = 'ramais_project.urls'
...
WSGI_APPLICATION = 'ramais_project.wsgi.application'
